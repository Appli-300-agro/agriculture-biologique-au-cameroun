...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { role: 'bot', text: 'Bonjour ! Je suis l\'assistant IA de Agriculture biologique au cameroun. Comment puis-je vous aider aujourd\'hui ?' }
  ]);
        ...
        <div className="absolute bottom-16 right-0 w-80 md:w-96 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col h-[500px]">
          ...
          <div className="bg-primary p-4 text-white flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-[10px] opacity-80">En ligne | Agriculture biologique au cameroun</p>
            </div>
          </div>
